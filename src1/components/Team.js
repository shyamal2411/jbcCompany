    ...
    <>
      <div className="flex justify-center items-center">
        <section className="pb-10 lg:pt-[120px] lg:pb-20">
          <div className="container bg-red-100 mx-50">
            <div className="mx-4 flex bg-red-200 flex-wrap">
              {/* <div className="container bg-red-300 px-4"> */}
              <div className="mx-auto bg-red-300 mb-[60px] max-w-[510px] text-lg text-center">
